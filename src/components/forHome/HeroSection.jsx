    ...
    return (
        <main className='bg-secondaryBgColor mx-6 md:mx-20 rounded-3xl md:rounded-[58px]'>
            ...
            >
                ...
                {/* Hero Section Titles */}
                <h1 className="max-w-[806px] mx-5 text-2xl vsm:text-4xl md:text-6xl font-semibold vsm:leading-[51.96px] md:leading-[81.96px]">Lorem ipsum dolor sit amet consectetur adipiscing</h1>
