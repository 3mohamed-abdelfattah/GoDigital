...
export const WhyDigitalSection = () => {
    return (
        <main className="max-w-[1754px] xl:h-[615px] bg-secondaryColor rounded-3xl lg:rounded-[58px] text-center mt-10 md:mt-[139px] mx-7 lg:mx-20 p-5 vsm:p-8 lg:p-12">
            ...
            <h2 data-aos="zoom-in" className="max-w-[911px] mt-3 text-primaryColor font-medium text-xs tiny:text-lg sm:text-[22px] sm:leading-[30.05px] mx-auto">Στην Go Digital απλοποιούμε την ασφάλιση ψηφιακά και φέρνουμε στην οθόνη σας τις καλύτερες επιλογές ταξιδιωτικής ασφάλισης.</h2>
