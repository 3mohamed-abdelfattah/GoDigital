// Components
import { Header, ImageSlider, HeroBlogSection } from "@/components"
// Images
...
export const BlogPage = () => {
    return (
        <main>
            ...
            <aside className="flex flex-col lg:flex-row justify-end lg:justify-center gap-10 lg:pl-32 items-center my-8 sm:my-16 lg:my-48 overflow-hidden">
