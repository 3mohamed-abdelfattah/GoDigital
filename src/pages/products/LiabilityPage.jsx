...
const slidesData = [
    {
        title: "Κάλυψη Επαγγελματικής Ευθύνης",
        description: "Καλύπτει απαιτήσεις που εγείρονται κατά του ασφαλισμένου και αφορούν παραβίαση καθήκοντος λόγω αμέλειας, λανθασμένων ενεργειών ή παραλείψεων, που προκύπτουν από την άσκηση και διεξαγωγή της επαγγελματικής δραστηριότητας."
    }
];
...
export const LiabilityPage = () => {
    return (
        <>
            ...
            <CoveragesSection title="Οι καλύψεις μας" description="Οι καλύψεις που προσφέρει το συμβόλαιο Ασφάλισης Επαγγελματικής Ευθύνης Οδικού Μεταφορέα της GoDigital, εξασφαλίζουν τη μέγιστη προστασία για να εξασκείτε το επάγγελμα σας με τον καλύτερο τρόπο. Πάντα να βεβαιώνεστε ποιες καλύψεις περιλαμβάνονται στο συμβόλαιο σας." data={slidesData} />
            ...
            <section className="bg-secondaryColor mx-7 lg:mx-20 rounded-b-3xl md:rounded-b-[58px] rounded-t-[30px] md:rounded-t-[70px] my-5 md:my-20">
                ...
                >
                    ...
                    <h2 data-aos="zoom-in" className="mt-5 mb-6 mx-2 sm:text-[22px] sm:leading-[30.05px]">Στην Go Digital απλοποιούμε την ασφάλιση ψηφιακά και φέρνουμε στην οθόνη σας την καλύτερη πρόταση Επαγγελματικής Ευθύνης Οδικού Μεταφορέα </h2>
                </article>
                {/* Services Rectangles */}
