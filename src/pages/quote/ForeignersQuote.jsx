                ...
                <div className="my-10 flex flex-wrap justify-center items-center gap-5">
                    ...
                    {currentStep === 0 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            ...
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Ποιο είναι το όνομά σου;</h1>
                            <TravelSelect
                                ...
                                options={locations}
                            />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Ποιο είναι το επώνυμό σου;</h1>
                            <TravelSelect
                    ...
                    {currentStep === 1 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            <Icons.QuoteCardIcon />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Ποιά είναι η εθνικότητά σου;</h1>
                            <TravelInput
                                type="text"
                            ...
                            />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Γράψε τον αριθμό της ταυτότητας ή του διαβατηρίου σου:</h1>
                            <TravelInput
                                type="text"
                    ...
                    {currentStep === 2 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            ...
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Πότε είναι τα γενέθλιά σου;</h1>
                            <TravelSelect
                            ...
                            />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Παρακαλούμε επίλεξε το φύλο σου:</h1>
                            <TravelSelect
                                placeholder="Preference"
                                value={userData.step3.preference}
                                onChange={(e) =>
                    ...
                    {currentStep === 3 && (
                        <div className="flex flex-col justify-center items-center gap-10">
                            ...
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Επίλεξε την περίοδο ασφάλισης:</h1>
                            <TravelInput
                                placeholder="Date"
