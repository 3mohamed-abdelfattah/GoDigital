                ...
                <div className="flex flex-col justify-center items-center my-10">
                    ...
                    ${index === currentStep ? "ml-[50px] md:ml-16" : ""}`}
                        ...
                        <span
                            ...
                            style={{
                                left: `calc(${currentStep * 19.5}%)`, // Adjusts plane's position dynamically based on the current step
                            }}
                        >
                ...
                <div className="my-5 flex flex-wrap justify-center items-center gap-5">
                    ...
                    {currentStep === 0 && (
                        <div className="flex flex-col justify-center items-center gap-5">
                            ...
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Τύπος Εγγύησης</h1>
                            <TravelSelect
                                ...
                                options={locations}
                            />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Ημ/νία έναρξης</h1>
                            <TravelSelect
                                ...
                                options={locations}
                            />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Ημ/νία λήξης</h1>
                            <TravelSelect
                                placeholder="Where are you travelling to?"
                                value={userData.step1.arrival}
                                onChange={(e) =>
                    ...
                    {currentStep === 1 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            ...
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Επιλογή προσώπου</h1>
                            <TravelInput
                                type="text"
                            ...
                            />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Ασφαλισμένος/Κάτοχος ασφαλιστηρίου</h1>
                            <TravelInput
                                type="text"
                                placeholder="Αριθμός ταυτότητας/διαβατηρίου"
                    ...
                    {currentStep === 2 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            <h1 className="text-2xl sm:text-4xl text-center font-semibold">Συμπλήρωσε τα στοιχεία κατόχου ασφαλιστηρίου</h1>
                            <TravelSelect
                    ...
                    {currentStep === 3 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            <h1 className="text-2xl sm:text-4xl text-center font-semibold">Συμπλήρωσε τα στοιχεία δικαιούχου</h1>
                            <TravelInput
                                placeholder="Date"
                    ...
                    {currentStep === 4 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            <h1 className="text-2xl sm:text-4xl text-center font-semibold">Συμπλήρωσε τις λεπτομέρειες εγγύησης</h1>
                            <TravelInput
                                placeholder="Date"
                                value={userData.step5.form}
                                onChange={(e) =>
                                    handleInputChange("step5", "form", e.target.value)
                                }
                                isInvalid={isInvalid && !userData.step5.form}
                            />
                            <h2>Form will be here</h2>
                        </div>
                    )}
