                ...
                <div className="flex flex-col justify-center items-center my-10">
                    ...
                    ${index === currentStep ? "ml-[70px] md:ml-16" : ""}`}
                        ...
                        <span
                            ...
                            style={{
                                left: `calc(${currentStep * 32}%)`, // Adjusts plane's position dynamically based on the current step
                            }}
                        >
                ...
                <div className="my-10 flex flex-wrap justify-center items-center gap-5">
                    ...
                    {currentStep === 0 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            ...
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Κατηγορία ασφαλιστικού διαμεσολαβητή</h1>
                            <TravelSelect
                                ...
                                options={locations}
                            />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Πότε ξεκίνησες να ασκείς το επάγγελμά σου;</h1>
                            <TravelSelect
                    ...
                    {currentStep === 1 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            ...
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Έναρξη ασφάλισης</h1>
                            <TravelInput
                                type="text"
                    ...
                    {currentStep === 2 && (
                        <div className="flex flex-col justify-center items-center gap-5 sm:gap-10">
                            ...
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Τελευταίο οικονομικό έτος</h1>
                            <TravelSelect
                            ...
                            />
                            <h1 className="max-w-[683px] text-2xl sm:text-4xl text-center font-semibold">Τρέχον οικονομικό έτος, εκτίμηση για την επιχείρησή σας</h1>
                            <TravelSelect
                                placeholder="Preference"
                                value={userData.step3.preference}
                                onChange={(e) =>
